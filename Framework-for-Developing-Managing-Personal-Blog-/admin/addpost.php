...
<?php include 'includes/sidenav.php';?>
            ...
            <div class="box round first grid">
                ...
                if($_SERVER['REQUEST_METHOD'] == "POST"){
                    ...
                    if($title == "" || $category == "" || $body == "" || $author == "" || $tags == "" || $file_name == ""){
                        echo "<span style='color: red; font-weight: bold;'>Fields Must not be empty</span>";
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <?php
                                    ...
                                    $category_selection = $db->select($myQuery);
                                    if($category_selection){
                                        while($result = $category_selection->fetch_assoc()){
